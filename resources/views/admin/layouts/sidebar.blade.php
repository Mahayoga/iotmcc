  ...
  <div class="sidebar-content">
    <nav class="sidebar-nav">
      <ul class="nav flex-column">
        ...
        @if(Route::currentRouteName() == 'alat-bleaching.index' || Route::currentRouteName() == 'ruang-fermentasi.index' || Route::currentRouteName() == 'ruang-pengeringan.index')
          <li class="nav-item">
            ...
            <div class="collapse show" id="collapseGudang">
              <ul class="nav nav-submenu">
                ...
                <!-- Ruang bleaching -->
                @if(Route::currentRouteName() == 'alat-bleaching.index')
                  <li class="nav-item">
                    <a class="nav-link active" href="{{ route('alat-bleaching.index') }}">
                      <i class="bi bi-fire"></i>
                      <span>Alat Bleaching</span>
                    </a>
                  </li>
                @else
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('alat-bleaching.index') }}">
                      <i class="bi bi-fire"></i>
                      <span>Alat Bleaching</span>
                    </a>
                  </li>
